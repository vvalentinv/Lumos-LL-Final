...
const getUuidByEmail = async (user) => {
  ...
  // }
  uuid = checkUser[0].id;
  console.log("uuid in combined functions", uuid);
  return uuid;
};

module.exports = { getUuidByEmail, getAllUsers, getAllDecks, getAllCards, getAllDeckCards, getAllCategories, getAllDecksForUser, getAllCardsForDeck, storeUser, getUserIdByEmail, storeDeck, storeCard, linkCardToDeck };
